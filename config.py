...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7204886001').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "Storageofiles_bot") # without @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://kingofpigs.onrender.com")
